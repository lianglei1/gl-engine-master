    ...
    if (ImGui::CollapsingHeader("Rendering", 0, true, true))
    {
        ...
        if (ImGui::TreeNode("Object"))
        {
            ...
            if (ImGui::TreeNode("Material"))
            {
                ...
                {
                    objectAlbedo.setTexture("resources/textures/pbr/brick-wall-ue/brick-wall_albedo.png", "brickwallAlbedo", true);
                    objectNormal.setTexture("resources/textures/pbr/brick-wall-ue/brick-wall_normal-dx.png", "brickwallNormal", true);
                    objectRoughness.setTexture("resources/textures/pbr/brick-wall-ue/brick-wall_roughness.png", "brickwallRoughness", true);
                    objectMetalness.setTexture("resources/textures/pbr/brick-wall-ue/brick-wall_metallic.png", "brickwallMetalness", true);
                    objectAO.setTexture("resources/textures/pbr/brick-wall-ue/brick-wall_ao.png", "brickwallAO", true);
